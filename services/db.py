...
def connect_db() -> sqlite3.Connection:
    ...
    Returns:
        sqlite3.Connection: Active connection object to the database.
    """
...
def init_db() -> None:
    """
    Initialize the database schema and insert sample rooms.

    - Creates `rooms` and `bookings` tables if they do not exist.
    - Inserts predefined sample rooms with capacity and features.
    """
